...
# OUR TASK: We will try to investigate with our bayesian framework, how much heroin
# could Shonubi traffic in all of his trips

# First Problem: As you can see in the dataset, we have almost complete data about
# gross weight of drugs, but about net weight of drugs. We will try to fill those 
# missing values, we will try to predict them basic on the gross values.
...
#E6. Select onnly netEstimate and age, and only complete cases
...
# To make a rational use of the age_yrs variable we should standardize it,
# one of the reasons is that we want to consider only years that are present
# in our dataset
