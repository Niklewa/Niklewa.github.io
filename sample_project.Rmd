...
As it turns out, religious beliefs have a big influence on the probability of cohabiting, therefore we can risk a hypothesis that we find a hidden correlate. The bayesian dependency tree below illustrates the relation of the factors of our interest. $C$ stands for cohabitation, $A$ atheism, and $D$ divorce. So a confounder.
&nbsp; <br>
